...
This example omits the database path, because it assumes it's in [one of the data directories](https://jellyfin.org/docs/general/administration/configuration/#data-directory) specified in the Jellyfin documentation.
...
See [containers](./containers) for details on how to use this on a containerized setup.
